  ...
  <body>
    ...
    <div class="row mt-5 no-gutters " style="min-height:100vh;">
      ...
      <div class="col-md-10 bg-light">
        ...
        <a class="btn btn-success fw-bold" href="daftar_produk.php" role="button">Tambah</a>
        <div class="row">
          <?php 
          $nomor = 0;
        ...
        <div class="card ms-2 mt-2" style="width: 14rem">
          ...
          <div class="card-body">
            ...
            <a href="home.php?id_produk=<?php echo $show['id_produk'];?>" class="btn btn-danger fw-bold my-1" role="button">Hapus</a>
          </div>
        </div>
        <?php
      }
