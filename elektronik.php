  ...
  <nav class="navbar navbar-light pb-2 bg-light shadow fixed-top">
    ...
    <div class="row mt-5 no-gutters" style="min-height:100vh;">
      ...
      <div class="col-md-10 bg-light mt-3 pt-4">
        <h3 class="fw-bold my-3 text-center">Elektronik</h3>
        <div class="row">
          <?php 
          include "koneksi.php";
          $nomor = 0;
              $data = mysqli_query($mysqli,"SELECT * FROM produk where kategori='elektronik'");
        ...
        <div class="card ms-2 mt-2" style="width: 14rem">
          ...
          <h4 class="card-title mb-2"><?php echo $show['nama'];?></h4>
            ...
            <a href="elektronik.php?id_produk=<?php echo $show['id_produk'];?>" class="btn btn-danger fw-bold my-1" role="button">Hapus</a>
          </div>
        </div>
        <?php
      }
